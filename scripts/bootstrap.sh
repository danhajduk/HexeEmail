...
BACKEND_SERVICE_NAME="hexe-email-node-backend.service"
FRONTEND_SERVICE_NAME="hexe-email-node-frontend.service"
SYSTEMD_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/systemd/user"
BACKEND_TEMPLATE="$ROOT_DIR/scripts/systemd/hexe-email-node-backend.service.in"
FRONTEND_TEMPLATE="$ROOT_DIR/scripts/systemd/hexe-email-node-frontend.service.in"
