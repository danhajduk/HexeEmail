  ...
  return (
    <aside className="card operational-shell-nav-card">
      <nav className="operational-shell-nav" aria-label="Operational sections">
        ...
        <button
          type="button"
          className={`btn operational-nav-btn ${dashboardSection === "actions" ? "btn-primary" : ""}`}
          onClick={() => openDashboard("actions")}
        >
          Action Required
        </button>
        <button
          type="button"
          className={`btn operational-nav-btn ${dashboardSection === "review" ? "btn-primary" : ""}`}
