...
- scrub heuristic packs
- profile taxonomy and runtime rules
- validation policy
- decision policy
...
Shared family identity is declared in:
...
- flow-family runtime roots:
  - [runtime/flow_families/order](/home/dan/Projects/HexeEmail/runtime/flow_families/order)
  - [runtime/flow_families/action_needed](/home/dan/Projects/HexeEmail/runtime/flow_families/action_needed)

Current code-owned family config layout:

- ORDER heuristic/profile/policy packs:
...
- ACTION_NEEDED heuristic/profile/policy packs:
...
- [runtime/action_needed_templates](/home/dan/Projects/HexeEmail/runtime/action_needed_templates)

That ACTION_NEEDED path is still a skeleton-stage layout and can be normalized into `runtime/flow_families/action_needed/templates` in a later migration pass.
...
- put family-specific thresholds, heuristics, taxonomies, and routing in the family package
