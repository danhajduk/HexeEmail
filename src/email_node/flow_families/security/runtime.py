...
class SecurityFlowRuntime(SharedFamilyProbationRuntimeMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self.probation_store = probation_store or ProbationStore(runtime_dir=runtime_dir, flow_family="security")
    ...
    def _build_probation_request(self, phase4) -> PatternGenerationRequest:
        return build_family_ai_template_request(
            phase4,
            expected_label="SECURITY",
            fallback_template_root="security",
        )
