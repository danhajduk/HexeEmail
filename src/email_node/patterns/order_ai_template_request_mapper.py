...
def sanitize_order_template_identifier(value: str, *, fallback: str) -> str:
    normalized = re.sub(r"[^a-z0-9]+", "_", value.strip().lower()).strip("_")
    return normalized or fallback


def build_order_ai_template_request(phase4) -> PatternGenerationRequest:
    ...
    template_root = sanitize_order_template_identifier(profile_id, fallback="order_template")
    vendor_root = sanitize_order_template_identifier(vendor_identity, fallback="generic")
