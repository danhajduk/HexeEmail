...
def sanitize_action_required_template_identifier(value: str, *, fallback: str) -> str:
    normalized = re.sub(r"[^a-z0-9]+", "_", value.strip().lower()).strip("_")
    return normalized or fallback


def build_action_required_ai_template_request(phase4) -> PatternGenerationRequest:
    ...
    template_root = sanitize_action_required_template_identifier(profile_id, fallback="action_required_template")
    vendor_root = sanitize_action_required_template_identifier(vendor_identity, fallback="generic")
