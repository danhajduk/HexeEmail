...
from email_node.flow_families.action_needed.runtime import ActionNeededFlowRuntime


class ActionNeededFlowPipeline:
    flow_family = "action_needed"

    def __init__(self, *, runtime_dir: Path | None = None) -> None:
        self.runtime = ActionNeededFlowRuntime(runtime_dir=runtime_dir)
